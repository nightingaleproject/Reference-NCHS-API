...
This version of the API uses [VRDR.Messaging 4.1.10](https://www.nuget.org/packages/VRDR.Messaging/4.1.10) and [BFDR.Messaging 1.0.0-preview](https://www.nuget.org/packages/BFDR.Messaging/1.0.0-preview)
